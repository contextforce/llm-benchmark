...
## Highlights
* **qwq-32B** - This model is from Alibaba that is at the level of DeepSeek R1 but it is only at 32B parameters (much smaller than DeepSeek R1) - 3/8/2025
* **deepseek R1** - This model 
