...
* **llama-3.1-8B-Instant-128k** from Groq can produce 750 token/sec at $0.05/1M tokens. It is great for speed reasoning.
* **gemini-1.5-flash** is a surprise to the market. It has good quality, 1M context window size, fast and cost-effective. Paid version allows you to reach 2k requests/minute with 4M TPM. That is way above all models in the market in terms of speed and context size.
<br/>
